...
#
# Usage:
#   MODE=static  bash run_handheld_random_spoof_1580_x3.sh
#   MODE=removal bash run_handheld_random_spoof_1580_x3.sh
#
...
OUT_ROOT="$LVI_DATASET_DIR/repeat_${MODE}/random_1580"
...
for RUN_INDEX in $(seq "$START_RUN" "$N_POSITIONS"); do
    ...
    echo "============================================================"
    echo "[RUN $RUN_ID/$N_POSITIONS] handheld random $MODE D=15 range=80"
    ...
    ATTACK_BAG="$RUN_DIR/handheld_attack_${MODE}_random_1580_run_${RUN_ID}.bag"
    RUN_CONFIG="$RUN_DIR/config_random_${MODE}_${RUN_ID}.json"
    TRAJ_BAG="$RUN_DIR/handheld_attack_${MODE}_random_1580_run_${RUN_ID}_traj.bag"
    TRAJ_CSV="$RUN_DIR/handheld_attack_${MODE}_random_1580_run_${RUN_ID}_traj.csv"
