...
OUT_ROOT="$LVI_DATASET_DIR/repeat_removal/smvs_1580"
...
for RUN_INDEX in $(seq "$START_RUN" "$N_RUNS"); do
    ...
    echo "============================================================"
    echo "[RUN $RUN_ID/$N_RUNS] handheld smvs removal D=15 range=80"
    echo "============================================================"
    ...
    ATTACK_BAG="$RUN_DIR/handheld_attack_removal_smvs_1580_run_${RUN_ID}.bag"
    RUN_CONFIG="$RUN_DIR/config_smvs_removal_${RUN_ID}.json"
    TRAJ_BAG="$RUN_DIR/handheld_attack_removal_smvs_1580_run_${RUN_ID}_traj.bag"
    TRAJ_CSV="$RUN_DIR/handheld_attack_removal_smvs_1580_run_${RUN_ID}_traj.csv"
